  ...
  return (
    <main className="min-h-screen bg-slate-50 max-w-md mx-auto p-6 pb-24">
      <header className="mb-8">
        ...
        <h1 className="text-4xl font-black text-slate-800 tracking-tighter">日付別戦績</h1>
        <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Session Analytics</p>
      </header>
